...
echo ""
echo "If you use the venv with Lucy, build and launch Lucy from Terminal with:"
echo "  PYTHON=$VENV/bin/python ./build_lucy_app.sh"
echo "  PYTHON=$VENV/bin/python ~/Applications/Lucy.app/Contents/MacOS/Lucy"
echo ""
echo "For Finder/open launches, set the GUI environment first:"
echo "  launchctl setenv PYTHON $VENV/bin/python"
echo "  open ~/Applications/Lucy.app"
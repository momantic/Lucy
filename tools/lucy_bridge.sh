...
while true; do
  ...
  if echo "$LOWER" | grep -q "linkedin post about\|write me a linkedin post about\|draft a linkedin post about\|make me a linkedin post about"; then
    echo ""
    echo "Lucy: researching visible LinkedIn content and drafting locally with a local model..."
    ...
    echo "Lucy: I only handle the LinkedIn local model command in this bridge right now."
